...
class GraphForm(forms.Form):
    ...
    wave_length_diff = forms.FloatField(label='Разница длин волн [нм]', min_value=0, step_size=0.001, initial=0)
    ...
    refractive_index = forms.FloatField(label='Показатель преломления', min_value=1, step_size=0.000001, initial=1)
